const ASSET_BASE = import.meta.env.VITE_WEB_ASSET_BASE ?? "https://base-merge.vercel.app";
...
export const TOKEN_LADDER: TokenTier[] = [
  ...
  },
  {
    ...
    level: 4,
    slug: "clanker",
    asset: asset("/tokens/clanker.png"),
    symbol: "$CLANKER",
    name: "Clanker",
  ...
  },
  {
    ...
    level: 8,
    slug: "avantis",
    asset: asset("/tokens/avantis.png"),
    symbol: "$AVNT",
    name: "Avantis",
  ...
  },
  {
    ...
    level: 9,
    slug: "virtuals",
    asset: asset("/tokens/virtuals.png"),
    symbol: "$VIRTUAL",
  ...
  },
  {
    ...
    level: 10,
    slug: "aerodrome",
    asset: asset("/tokens/aerodrome.png"),
    symbol: "$AERO",
